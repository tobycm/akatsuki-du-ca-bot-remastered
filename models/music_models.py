...
class Player(WavelinkPlayer):
    ...
    loop_mode: Optional[Union[Literal["off"], Literal["song"], Literal["queue"]]]
...
class PageSelect(Select):
    ...
    def __init__(
        self, embed_size: int, embeds: list[Embed], lang: dict, itr: Interaction
    ) -> None:
    ...
    async def callback(self, interaction: Interaction):
        ...
        await self.itr.edit_original_response(
            embed=rich_embeds(self.embeds[page], interaction.user, self.lang["main"])
        )
